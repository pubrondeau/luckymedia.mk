    ...
    <div class="container">
        <div class="row my-auto items-center">
            <div class="col-12 flex flex-row items-center">
                <svg class="block fill-current h-16 w-16 md:w-24 md:h-24 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                     viewBox="0 0 48 48">
                ...
                <h2 class="text-3xl md:text-5xl font-bold text-gray-500 ml-8 md:ml-12">{{ $title }}</h2>
            </div>
        </div>
    </div>
</div>