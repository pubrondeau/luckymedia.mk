...
<div class="container mt-24 lg:mt-32 mb-48">
    ...
    <div class="row items-center mt-20 lg:mt-32">
        ...
        <div class="lg:col-3 lg:-ml-8">
            <div
                class="lg:h-64 h-40 bg-blue-500 rounded-br-lg rounded-bl-lg lg:rounded-bl-none lg:rounded-tr-lg lg:rounded-br-lg flex flex-col justify-center items-start px-5">
