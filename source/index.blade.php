            ...
            <div class="col-6 flex justify-end">
                ...
                <ul class="hidden lg:flex lg:flex-row">
                    @foreach($page->homepage->menu as $menu)
                        <li class="mr-4 xl:mr-8 last:mr-0">
