...
@section('body')
    ...
    <div class="container mt-24 mb-32">
        <div class="row items-center">
            ...
            <div class="col-6 offset-1 relative">
                ...
                <img style="margin-top: -400px; margin-left: 250px; z-index: -1" class="absolute" src="assets/images/triangle.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="bg-black">
        <div class="container py-16">
            <div class="row justify-center">
                <svg class="block fill-current w-12 h-12 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48">
    ...
    <div class="container -mt-24">
      <div class="row justify-center">
          <svg class="block fill-current w-12 h-12 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48">
              <path d="M0 24l10.286-10.286L20.57 24 10.286 34.286 0 24zM13.714 10.286L24 0l10.286 10.286L24 20.57 13.714 10.286zM13.714 37.714L24 27.43l10.286 10.285L24 48 13.714 37.714zM27.429 24l10.285-10.286L48 24 37.714 34.286 27.43 24z"/>
          </svg>
      </div>
    </div>
        ...
        <div class="container pb-56">
            <div class="row justify-center">
              <div class="flex flex-col items-center">
                  ...
                  <svg class="block fill-current w-12 h-12 text-black mt-12" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48">
                      <path d="M0 24l10.286-10.286L20.57 24 10.286 34.286 0 24zM13.714 10.286L24 0l10.286 10.286L24 20.57 13.714 10.286zM13.714 37.714L24 27.43l10.286 10.285L24 48 13.714 37.714zM27.429 24l10.285-10.286L48 24 37.714 34.286 27.43 24z"/>
                  </svg>
            ...
            <div class="row justify-center relative mt-24">
                <div class="col-8 dots">
                    <div class="bg-white shadow-lg p-4">
                        <img class="w-full h-auto" src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80" alt="">
                    </div>
                </div>
            </div>
        </div>
