                        ...
                        <div class="md:w-1/2 flex flex-col">
                            ...
                            <form class="mt-6 flex flex-col" action="">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <textarea placeholder="Message" class="form form-area py-4 mt-6" name="message" id="message"></textarea>
                                </div>
                               <div class="flex justify-end">
                                   <button class="flex flex-row items-center bg-blue-500 text-white text-sm py-4 px-8 mt-4">
                                       Send Message
                                       <v-icon name="arrow" class="w-6 h-6 text-white ml-1"></v-icon>
                                   </button>
                               </div>
                            </form>
                        </div>
